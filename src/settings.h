// clang-format off
	...
	*/
	...
	#define BUTTON_2_LONG     CMD_SLEEP_TIMER_MOD_30
	#define BUTTON_3_LONG     CMD_SLEEPMODE
	#define BUTTON_4_LONG     CMD_VOLUMEUP
	#define BUTTON_5_LONG     CMD_VOLUMEDOWN

	#define BUTTON_MULTI_01   CMD_TOGGLE_BLUETOOTH_SOURCE_MODE   //CMD_TOGGLE_WIFI_STATUS (disabled now to prevent children from unwanted WiFi-disable)
	...
	// (optinal) Neopixel
		...
		#define NUM_CONTROL_LEDS		5		// optional control leds (https://forum.espuino.de/t/statische-ws2812-leds/1703)
                #define CONTROL_LEDS_COLORS		{CRGB::Red, CRGB::Yellow, CRGB::Blue, CRGB::Blue, CRGB::Green}
		// Colors for the control LEDs. Make sure it lists at least NUM_CONTROL_LEDS colors, e.g. for three control LEDs define: CONTROL_LEDS_COLORS {CRGB::Yellow, CRGB::Blue, 0xFFFFFF} (predefined colors: http://fastled.io/docs/3.1/struct_c_r_g_b.html)
